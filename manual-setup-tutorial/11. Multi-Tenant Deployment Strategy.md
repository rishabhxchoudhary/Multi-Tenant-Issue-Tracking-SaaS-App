...
│   ├── IssueTracker-IssueManagement (handles all Basic companies)
│   ├── IssueTracker-TeamManagement (serves multiple companies)
│   └── IssueTracker-UserManagement (shared across tenants)
├── Shared DynamoDB Tables
│   ├── IssueTracker-Issues-Pooled (company_id partitioning)
│   ├── IssueTracker-Teams-Pooled (company isolation via keys)
│   └── IssueTracker-Users-Pooled (multi-tenant data)
...
tenant_tiers:
  basic:
    ...
    resources:
      lambda_functions:
        ...
        - "IssueTracker-TeamManagement"
        - "IssueTracker-UserManagement"
      databases:
  ...
  premium:
    ...
    resources:
      lambda_functions:
        - "IssueTracker-Premium-IssueManagement"
        - "IssueTracker-Premium-TeamManagement"
      databases:
        - "IssueTracker-Premium-Issues"
        - "IssueTracker-Premium-Teams"
...
class MultiTenantDeploymentManager:
    ...
    def _deploy_development(self, version: str) -> bool:
        ...
        try:
            ...
            shared_functions = [
                'IssueTracker-IssueManagement-Dev',
                'IssueTracker-TeamManagement-Dev',
                'IssueTracker-UserManagement-Dev'
            ]
