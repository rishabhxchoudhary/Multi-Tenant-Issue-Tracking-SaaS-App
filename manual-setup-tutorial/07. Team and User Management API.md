...
- **Existing role**: `IssueTracker-CompanyUserRole`
...
_💡 Pro Tip: Test team operations with different user roles to verify the permission system works correctly. Each role should have appropriate access levels!_

_🎯 Remember: Teams are the foundation of efficient issue tracking. Well-organized teams resolve issues faster and provide better collaboration than individual assignments._
