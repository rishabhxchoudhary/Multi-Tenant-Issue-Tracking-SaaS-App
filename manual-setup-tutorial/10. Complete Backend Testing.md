...
class IssueTrackingTestConfig:
    ...
    issues_table_name: str = 'SaaS-Issues-Pooled'
    teams_table_name: str = 'SaaS-Teams-Pooled'
    users_table_name: str = 'SaaS-Users-Pooled'
    companies_table_name: str = 'SaaS-CompanyManagement'
    comments_table_name: str = 'SaaS-Comments-Pooled'
...
class TestIssueManagement:
    ...
    def sample_context(self):
        ...
        context = Mock()
        context.function_name = 'SaaS-IssueManagement'
...
aws lambda invoke --function-name SaaS-IssueManagement --payload '{}' response.json
```
